...
ECHO_T = 
EXEEXT = 
EXTRA_CMA =  str.cma typeutil.cma settings.cma checked.cma GT.cma ostap.cmo
...
MINGW32_FALSE = 
MINGW32_TRUE = #
MODULE_INCLUDES =  -I /usr/local/lib/ocaml/4.01.0/typeutil -I /usr/local/lib/ocaml/4.01.0/settings -I /usr/local/lib/ocaml/4.01.0/checked -I /usr/local/lib/ocaml/4.01.0/GT -I /usr/local/lib/ocaml/4.01.0/ostap
OCAMLC = ocamlc.opt
OCAMLDEP = ocamldep
OCAMLDOC = ocamldoc
OCAMLDSORT = echo
